...
INSERT INTO MENOR_IDADE_TB(PK_CPF, NOME, SEXO, DATA_NASCIMENTO, ENDERECO_PAX, TELEFONES, EMAIL,AUTORIZACAO_VIAGEM)
VALUES('12345678999','MARCOS','M',TO_DATE('14/01/2000','DD/MM/YYYY'),TP_ENDERECO('BRASIL','123','BAHIA','SALVADOR','123 RUA'),
    TP_FONES(TP_FONE('55','71','983439843'),TP_FONE('55','89','948343888')),'MARCOS@GMAIL.COM','SIM');

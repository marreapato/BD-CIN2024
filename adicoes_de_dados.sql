...
DROP TABLE ESTAD_REGISTRADA_TB;
...
--CREATE OR REPLACE TYPE COMPRA_RELAC_TP AS OBJECT(
  --  PASSAGEIRO REF TP_PESSOA,
    --TICKET REF PASSAGEM_TP    
--);

--CREATE OR REPLACE TYPE TP_COMPRAS AS VARRAY(5) OF COMPRA_RELAC_TP;
...
--CREATE TABLE COMPRA_CLIENTE_TB OF COMPRA_CLIENTE_TP;
